...
import Map from '../chart/chartone';
            ...
            <div className="container-fluid">
                ...
                <div className="row d-flex justify-content-around ">
                    {data.map((val: any, i: any) => {
                        return (
                            <div className={` py-5 px-5 col-3 ms-1 mt-2    position-relative `}>
                                {val.icon}
                ...
                <div className=' mt-3 border mb-5' >
                    <h1 className='text-center text-white border mb-5 py-2' style={{backgroundColor:'#17948a'}}>Chart View of present Students</h1>
                    <Map></Map>
                </div>
                <div className='col-7'>
